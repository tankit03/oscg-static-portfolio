...
export default function HeroSection() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:gap-16 mt-8">
      {/* TitleCard */}
      <div className="w-[80%] md:w-[70%] md:max-w-[400px] h-auto mb-4 md:mb-0">
        <TitleCard />
      </div>
      ...
      <div className="w-[80%] md:w-[80%] md:max-w-[400px] h-auto p-4">
        <TypewriterEffect
          words={[
            { text: "What", className: "font-satoshiBold text-primaryOrange text-[28px] md:text-[36px]" },
            { text: "Do", className: "font-satoshiBold text-primaryOrange text-[28px] md:text-[36px]" },
            { text: "We", className: "font-satoshiBold text-primaryOrange text-[28px] md:text-[36px]" },
            { text: "Do ?", className: "font-satoshiBold text-primaryOrange text-[28px] md:text-[36px]" }
          ]}
        />
